...
class PromptControlExperiment(ControlExperiment):
    ...
    def __init__(self, model, tokenizer, device, plot_dir, bias_type="authority", likert_levels=None, is_testing_mode=False, num_permutations=5, reasoning_temperature=0.7, choice_temperature=1.0, experiment_suffix=""):
    ...
    def _get_prompt_choice_probabilities(self, prompts, batch_mode, mcq_prompt_addon, target_token_map, level=None, mcq_scenario_key='', **kwargs):
        ...
        if batch_mode:
            ...
            print(f"[INFO] Prompt experiment batch mode: Processing {len(prompts)} prompts")
            ...
            for i in range(0, len(prompts), self.reasoning_batch_size):
                ...
                current_batch_size = len(batch_prompts_for_gen)
                ...
                outputs = self.model.generate(
                    ...
                    max_new_tokens=64,  # Changed to 64 for thinking tokens
